...
class UnetModel(AiModel):
    ...
    def __init__(self, model_id: str):
        ...
        self.__load_segmentator(cls2bgr)

    def __load_segmentator(self, cls2bgr):
        # self.detector = load_detector()
        self.segmentator = load_segmentator(cls2bgr=cls2bgr)
        self.logger.info(f"Loaded YOLO model: {cls2bgr}")
